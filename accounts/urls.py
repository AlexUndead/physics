...
urlpatterns = [
    ...
    path('settings/change/<int:pk>/', custom_views.AccountSettingsChangeView.as_view(), name='upload_avatar'),
    path('settings/', custom_views.AccountSettingsView.as_view(), name='account_settings'),
